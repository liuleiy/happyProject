...
public class GameSend {
	...
	public GameSend(String id, int gtype, int rtype, int dtype, int ltype,
			String name, long status, long count, long ante, long cost,
			long vip, long chip, boolean deal, long carry, long down, long top,
			long sit, int del, String node, String ctime, long num,
	...
	public String toString() {
		return "GameSend [id=" + id + ", gtype=" + gtype + ", rtype=" + rtype
				+ ", dtype=" + dtype + ", ltype=" + ltype + ", name=" + name
				+ ", status=" + status + ", count=" + count + ", ante=" + ante
				+ ", cost=" + cost + ", vip=" + vip + ", chip=" + chip
				+ ", deal=" + deal + ", carry=" + carry + ", down=" + down
				+ ", top=" + top + ", sit=" + sit + ", del=" + del + ", node="
				+ node + ", ctime=" + ctime + ", num=" + num + ", minimum="
